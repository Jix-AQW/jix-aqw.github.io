...
As classes que passam com maior facilidade desta fase são: 
- [[Chaos Avenger]]
- [[Verus DoomKnight]]
- [[Legion DoomKnight]]
- [[Void Highlord]]
- [[Dragon of Time]]! (apenas cuidado ao utilizar habilidades que gastem vida) 
...
Recomendo utilizar classes que tenham dano em área e com boa sobrevivência como: 

- [[ArchMage]]
- [[BlazeBinder]]
- [[Dragon of Time]] 

Classes de único alvo também funcionam aqui, porém você vai precisar alternar alvo sempre que uma tartaruga virar.
...
Enhancements de life steal: 
- Dauntless
- Health Vamp

Consumíveis com Life Steal:
- Scroll of LifeSteal, que vende no shop da Reens em Arcangrove
